...
const GameManager = (function () {
  ...
  function startGame() {
    ...
    // bradleyAssault stages (stage 19 Treeline) seed their own mission in startWave.
    if (!(STAGES[currentStage] && (STAGES[currentStage].droneOnly || STAGES[currentStage].bradleyAssault))) {
      if (STAGES[currentStage] && STAGES[currentStage].capitalDefense) {
