...
const GameManager = (function () {
  ...
  function update() {
    ...
    if (window.LochDock) LochDock.update(delta);
    if (window.StrathKeep) StrathKeep.update(delta);
    if (window.KyleCamp) KyleCamp.update(delta);
    if (window.TarbetBase) TarbetBase.update(delta);
    if (window.RannochDock) RannochDock.update(delta);
    if (window.TrossachPost) TrossachPost.update(delta);
    if (window.AvonKeep) AvonKeep.update(delta);
    if (window.NessCamp) NessCamp.update(delta);
    if (window.DeargFort) DeargFort.update(delta);
    if (window.ErichtBase) ErichtBase.update(delta);
    if (window.SpeanCamp) SpeanCamp.update(delta);
    if (window.LochyKeep) LochyKeep.update(delta);
    if (window.LinnheDock) LinnheDock.update(delta);
    if (window.TummelPost) TummelPost.update(delta);
    if (window.EtiveCamp) EtiveCamp.update(delta);
    if (window.OrchyBase) OrchyBase.update(delta);
    if (window.CluanieFort) CluanieFort.update(delta);
    if (window.GarryBase) GarryBase.update(delta);
    if (window.LyonCamp) LyonCamp.update(delta);
    if (window.TayKeep) TayKeep.update(delta);
    if (window.EarnDock) EarnDock.update(delta);
    if (window.TeithPost) TeithPost.update(delta);
    if (window.ForthCamp) ForthCamp.update(delta);
    if (window.AllanBase) AllanBase.update(delta);
    if (window.DochartBase) DochartBase.update(delta);
    if (window.LenyCamp) LenyCamp.update(delta);
    if (window.LubnaigFort) LubnaigFort.update(delta);
    if (window.VenacharKeep) VenacharKeep.update(delta);
    if (window.KatrinePost) KatrinePost.update(delta);
    if (window.ArdDock) ArdDock.update(delta);
    if (window.LomondFort) LomondFort.update(delta);
    if (window.LongCamp) LongCamp.update(delta);
    if (window.FyneBase) FyneBase.update(delta);
    if (window.AweCamp) AweCamp.update(delta);
    if (window.ShiraFort) ShiraFort.update(delta);
    if (window.FeochanKeep) FeochanKeep.update(delta);
    if (window.NellDock) NellDock.update(delta);
    if (window.RuelPost) RuelPost.update(delta);
    if (window.GilpBase) GilpBase.update(delta);
    if (window.AddCamp) AddCamp.update(delta);
    if (window.CreranFort) CreranFort.update(delta);
    if (window.EtiveDock) EtiveDock.update(delta);
    if (window.SeilBase) SeilBase.update(delta);
    if (window.LuingKeep) LuingKeep.update(delta);
    if (window.JuraCamp) JuraCamp.update(delta);
    if (window.ScarbaPost) ScarbaPost.update(delta);
    if (window.OronsayFort) OronsayFort.update(delta);
    if (window.ColonsayBase) ColonsayBase.update(delta);
    if (window.IslayFort) IslayFort.update(delta);
    if (window.GighaBase) GighaBase.update(delta);
    if (window.KintyreCamp) KintyreCamp.update(delta);
    if (window.TarbertKeep) TarbertKeep.update(delta);
    if (window.SkipnessDock) SkipnessDock.update(delta);
    ...
    if (window.AppinBase) AppinBase.update(delta);
    if (window.GlencoeKeep) GlencoeKeep.update(delta);
    if (window.BallachulishPost) BallachulishPost.update(delta);
    if (window.KinlochlevenBase) KinlochlevenBase.update(delta);
    if (window.FortWilliamDock) FortWilliamDock.update(delta);
    if (window.SpeanBridgeCamp) SpeanBridgeCamp.update(delta);
    if (window.RoyBridgeFort) RoyBridgeFort.update(delta);
    if (window.LagganBase) LagganBase.update(delta);
    if (window.DalwhinnieFort) DalwhinnieFort.update(delta);
    if (window.DrumochterPost) DrumochterPost.update(delta);
    if (window.PitlochryKeep) PitlochryKeep.update(delta);
    if (window.BlairAthollBase) BlairAthollBase.update(delta);
    if (window.KilliecrankieFort) KilliecrankieFort.update(delta);
    if (window.AberfeldyDock) AberfeldyDock.update(delta);
    if (window.KenmoreCamp) KenmoreCamp.update(delta);
    if (window.LochTayBase) LochTayBase.update(delta);
    if (window.FortingallFort) FortingallFort.update(delta);
    if (window.GlenLyonPost) GlenLyonPost.update(delta);
    if (window.RannochKeep) RannochKeep.update(delta);
    if (window.BridgeOfOrchyBase) BridgeOfOrchyBase.update(delta);
    if (window.InveroranCamp) InveroranCamp.update(delta);
    if (window.BlackMountFort) BlackMountFort.update(delta);
    if (window.VictoriaBridgeDock) VictoriaBridgeDock.update(delta);
    if (window.TyndrumUpperBase) TyndrumUpperBase.update(delta);
    if (window.StrathyreFort) StrathyreFort.update(delta);
    if (window.LochEarnheadPost) LochEarnheadPost.update(delta);
    if (window.ComrieKeep) ComrieKeep.update(delta);
    if (window.CrieffBase) CrieffBase.update(delta);
    if (window.AuchterarderFort) AuchterarderFort.update(delta);
    if (window.StirlingDock) StirlingDock.update(delta);
    if (window.AlloaCamp) AlloaCamp.update(delta);
    if (window.FalkirkFort) FalkirkFort.update(delta);
    if (window.LinlithgowBase) LinlithgowBase.update(delta);
    if (window.BathgateKeep) BathgateKeep.update(delta);
    if (window.LivingstonPost) LivingstonPost.update(delta);
    if (window.PenicuikBase) PenicuikBase.update(delta);
    if (window.LoanheadFort) LoanheadFort.update(delta);
    if (window.BonnyriggCamp) BonnyriggCamp.update(delta);
    if (window.DalkeithDock) DalkeithDock.update(delta);
    ...
    if (window.InverarayFort) InverarayFort.update(delta);
    if (window.LochgilpheadBase) LochgilpheadBase.update(delta);
    if (window.ArdrishaigDock) ArdrishaigDock.update(delta);
    if (window.LochfyneCamp) LochfyneCamp.update(delta);
    if (window.TarbertLoch) TarbertLoch.update(delta);
    ...
    if (window.StrathfillanFort) StrathfillanFort.update(delta);
    if (window.KillinBase) KillinBase.update(delta);
    if (window.LochEarnCamp) LochEarnCamp.update(delta);
    if (window.BalquhidderKeep) BalquhidderKeep.update(delta);
    if (window.CallanderPost) CallanderPost.update(delta);
    ...
    if (window.YorkKeep) YorkKeep.update(delta);
    if (window.LeedsFort) LeedsFort.update(delta);
    if (window.SheffieldPost) SheffieldPost.update(delta);
    if (window.PeakDistrict) PeakDistrict.update(delta);
    if (window.NottinghamFort) NottinghamFort.update(delta);
    ...
    if (window.GuildfordSurrey) GuildfordSurrey.update(delta);
    if (window.ChichesterCathedral) ChichesterCathedral.update(delta);
    if (window.ArundelWestSussex) ArundelWestSussex.update(delta);
    if (window.BrightonPavilion) BrightonPavilion.update(delta);
    if (window.LewesDowns) LewesDowns.update(delta);
    ...
    if (window.GravesendThames) GravesendThames.update(delta);
    if (window.DartfordCrossing) DartfordCrossing.update(delta);
    ...
    if (window.Glendalough) Glendalough.update(delta);
    if (window.Newgrange) Newgrange.update(delta);
    if (window.TrimCastle) TrimCastle.update(delta);
    if (window.KylemoreAbbey) KylemoreAbbey.update(delta);
    if (window.SkelligMichael) SkelligMichael.update(delta);
    ...
    if (window.MayoWestport) MayoWestport.update(delta);
    if (window.AchillIsland) AchillIsland.update(delta);
    if (window.CroaghPatrick) CroaghPatrick.update(delta);
    if (window.CeideFields) CeideFields.update(delta);
    if (window.LoughCorrib) LoughCorrib.update(delta);
    ...
    if (window.BirrCastle) BirrCastle.update(delta);
    if (window.OffalyBog) OffalyBog.update(delta);
    if (window.LaoisRock) LaoisRock.update(delta);
    if (window.KildareCurragh) KildareCurragh.update(delta);
    if (window.MaynoothCastle) MaynoothCastle.update(delta);
    ...
    if (window.LondonderryWalls) LondonderryWalls.update(delta);
    if (window.CausewayCoast) CausewayCoast.update(delta);
    if (window.BallycastleHarbour) BallycastleHarbour.update(delta);
    if (window.RathlinIsland) RathlinIsland.update(delta);
    if (window.PortrushBeach) PortrushBeach.update(delta);
    ...
    if (window.NewcastleQuayside) NewcastleQuayside.update(delta);
    if (window.HarrogateSpa) HarrogateSpa.update(delta);
    if (window.FountainsAbbey) FountainsAbbey.update(delta);
    if (window.BamburghCastle) BamburghCastle.update(delta);
    if (window.LindisfarnePriory) LindisfarnePriory.update(delta);
    ...
    if (window.IronbridgeGorge) IronbridgeGorge.update(delta);
    if (window.GloucesterCathedral) GloucesterCathedral.update(delta);
    if (window.WorcesterCathedral) WorcesterCathedral.update(delta);
    if (window.StaffordCastle) StaffordCastle.update(delta);
    if (window.CheltenhamRacecourse) CheltenhamRacecourse.update(delta);
    if (window.BuryStEdmunds) BuryStEdmunds.update(delta);
    if (window.GreatYarmouth) GreatYarmouth.update(delta);
    if (window.KingsLynn) KingsLynn.update(delta);
    if (window.MatlockBath) MatlockBath.update(delta);
    if (window.BuxtonSpa) BuxtonSpa.update(delta);
    if (window.StamfordTown) StamfordTown.update(delta);
    if (window.NorthamptonCastle) NorthamptonCastle.update(delta);
    if (window.WiganPier) WiganPier.update(delta);
    ...
    if (window.TehranAzadi) TehranAzadi.update(delta);
    if (window.BaghdadCtesiphon) BaghdadCtesiphon.update(delta);
    if (window.BeirutDowntown) BeirutDowntown.update(delta);
    if (window.AmmanCitadel) AmmanCitadel.update(delta);
    if (window.RiyadhKingdom) RiyadhKingdom.update(delta);
    ...
    if (window.KensingtonMuseums) KensingtonMuseums.update(delta);
    if (window.ChelseaEmbankment) ChelseaEmbankment.update(delta);
    if (window.SouthwarkBridge) SouthwarkBridge.update(delta);
    if (window.BoroughMarket) BoroughMarket.update(delta);
    if (window.ElephantCastle) ElephantCastle.update(delta);
    ...
    if (window.CanaryWharfDocks) CanaryWharfDocks.update(delta);
    if (window.HackneyMarshes) HackneyMarshes.update(delta);
    if (window.StratfordOlympic) StratfordOlympic.update(delta);
    if (window.IslingtonCanal) IslingtonCanal.update(delta);
    if (window.CamdenMarket) CamdenMarket.update(delta);
    ...
    if (window.CrawleyGatwick) CrawleyGatwick.update(delta);
    if (window.HorshamMarket) HorshamMarket.update(delta);
    if (window.WorthingSeafront) WorthingSeafront.update(delta);
    if (window.ShorehamPort) ShorehamPort.update(delta);
    if (window.SouthamptonCommon) SouthamptonCommon.update(delta);
    ...
    if (window.Sherbornecastle) Sherbornecastle.update(delta);
    if (window.WestlandHelicopters) WestlandHelicopters.update(delta);
    if (window.TauntonCastle) TauntonCastle.update(delta);
    if (window.GlastonburyAbbey) GlastonburyAbbey.update(delta);
    if (window.WellsBishop) WellsBishop.update(delta);
    ...
    if (window.WemyssBayCamp) WemyssBayCamp.update(delta);
    if (window.LargsBase) LargsBase.update(delta);
    if (window.MillportKeep) MillportKeep.update(delta);
    if (window.KilbirnieFort) KilbirnieFort.update(delta);
    if (window.IrvineBase) IrvineBase.update(delta);
    if (window.KilmarnockFort) KilmarnockFort.update(delta);
    if (window.AyrDock) AyrDock.update(delta);
    if (window.PrestwickPost) PrestwickPost.update(delta);
    if (window.TroonCamp) TroonCamp.update(delta);
    if (window.ArdrossanBase) ArdrossanBase.update(delta);
    if (window.SaltcoatsKeep) SaltcoatsKeep.update(delta);
    if (window.ArranFort) ArranFort.update(delta);
    if (window.CampbeltownBase) CampbeltownBase.update(delta);
    if (window.MachrihanishFort) MachrihanishFort.update(delta);
    if (window.TarbertDock) TarbertDock.update(delta);
    if (window.InverarayKeep) InverarayKeep.update(delta);
    if (window.LochgilpheadPost) LochgilpheadPost.update(delta);
    if (window.KilmartinBase) KilmartinBase.update(delta);
    if (window.CrinanFort) CrinanFort.update(delta);
    if (window.JuraKeep) JuraKeep.update(delta);
    if (window.PortAskaigBase) PortAskaigBase.update(delta);
    if (window.BowmoreFort) BowmoreFort.update(delta);
    if (window.LaphroaigDock) LaphroaigDock.update(delta);
    if (window.ArdBegKeep) ArdBegKeep.update(delta);
    if (window.FinlagganPost) FinlagganPost.update(delta);
    if (window.PortCharlotteBase) PortCharlotteBase.update(delta);
    if (window.BruichladdiChFort) BruichladdiChFort.update(delta);
    if (window.KilchomanCamp) KilchomanCamp.update(delta);
    if (window.ColonsayFort) ColonsayFort.update(delta);
    if (window.OronsayBase) OronsayBase.update(delta);
    if (window.ScarbaKeep) ScarbaKeep.update(delta);
    if (window.GarvellachsPost) GarvellachsPost.update(delta);
    if (window.SeilIslandBase) SeilIslandBase.update(delta);
    if (window.LuingFort) LuingFort.update(delta);
    if (window.EasdaleDock) EasdaleDock.update(delta);
    if (window.KerreraCamp) KerreraCamp.update(delta);
