...
const CityBuildings = (function () {
  ...
  function industrialFactory(ox, oz, gy, w, d, h) {
    for (var y = 0; y < h; y++) { for (var x = 0; x < w; x++) { for (var z = 0; z < d; z++) { var isWall = x === 0 || x === w - 1 || z === 0 || z === d - 1; var isRoof = y === h - 1; if (isWall || isRoof) { var bt = PAL.METAL; if (y === 0) bt = PAL.CONCRETE; if (isRoof) { var saw = (x + z) % 4 < 2; bt = saw ? PAL.METAL : PAL.GLASS; } setBlock(ox + x, gy + y, oz + z, bt); } } } }
  ...
  function azovstalComplex(ox, oz, gy, w, d, h) {
    for (var y = 0; y < h; y++) { for (var x = 0; x < w; x++) { for (var z = 0; z < d; z++) { var isWall = x === 0 || x === w - 1 || z === 0 || z === d - 1; var isRoof = y === h - 1; if (isWall || isRoof) { var bt = PAL.METAL; if (y === 0) bt = PAL.CONCRETE; if (isRoof) bt = PAL.ROOFTILE; setBlock(ox + x, gy + y, oz + z, bt); } } } }
  ...
  // ── gumDepartmentStore ──
  function gumDepartmentStore(ox, oz, gy, w, d, h) { for (var y = 0; y < h; y++) { for (var x = 0; x < w; x++) { for (var z = 0; z < d; z++) { var isWall = x === 0 || x === w - 1 || z === 0 || z === d - 1; var isRoof = y === h - 1; if (isWall || isRoof) { var bt = PAL.CONCRETE; if (isRoof) bt = PAL.GLASS; setBlock(ox + x, gy + y, oz + z, bt); } } } } for (var y = 1; y < h - 1; y++) { for (var x = 2; x < w - 2; x++) { for (var z = 2; z < d - 2; z++) setBlock(ox + x, gy + y, oz + z, PAL.AIR); } } for (var x = 0; x < w; x++) { if (x % 2 === 0) { setBlock(ox + x, gy + 1, oz + d, PAL.STONE); setBlock(ox + x, gy + 2, oz + d, PAL.STONE); } } }

  // ── stateHistoricalMuseum ──
  function stateHistoricalMuseum(ox, oz, gy, w, d, h) { for (var y = 0; y < h; y++) { for (var x = 0; x < w; x++) { for (var z = 0; z < d; z++) { var isWall = x === 0 || x === w - 1 || z === 0 || z === d - 1; var isRoof = y === h - 1; if (isWall || isRoof) { var bt = PAL.BRICK; if (x === 0 || x === w - 1 || y === h - 1) bt = PAL.WHITE_TILE; setBlock(ox + x, gy + y, oz + z, bt); } } } } var corners = [[0,0],[w-1,0],[0,d-1],[w-1,d-1]]; for (var ci = 0; ci < 4; ci++) { var cx = ox + corners[ci][0], cz = oz + corners[ci][1]; for (var y = 0; y < 5; y++) setBlock(cx, gy + h + y, cz, PAL.WHITE_TILE); setBlock(cx, gy + h + 5, cz, PAL.METAL); } }
  ...
  // ── ruinedBuilding ──
  function ruinedBuilding(ox, oz, gy, w, d, h, collapse) { for (var y = 0; y < h; y++) { for (var x = 0; x < w; x++) { for (var z = 0; z < d; z++) { var isWall = x === 0 || x === w - 1 || z === 0 || z === d - 1; var isRoof = y === h - 1; if (isWall || isRoof) { if (collapse > 0) { var distFromCorner = Math.min(x + z, (w - x) + z, x + (d - z), (w - x) + (d - z)); if (distFromCorner < collapse * 3 && Math.random() < 0.6) continue; } var bt = (y === 0) ? PAL.BRICK : PAL.CONCRETE; if (y > h - 2 && Math.random() < 0.4) bt = PAL.RUBBLE; setBlock(ox + x, gy + y, oz + z, bt); } } } } }

  // ── school ──
  function school(ox, oz, gy, w, d, h) { for (var y = 0; y < h; y++) { for (var x = 0; x < w; x++) { for (var z = 0; z < d; z++) { var isWall = x === 0 || x === w - 1 || z === 0 || z === d - 1; var isRoof = y === h - 1; if (isWall || isRoof) { var bt = (y === 0) ? PAL.BRICK : PAL.CONCRETE; if (isRoof) bt = PAL.ROOFTILE; setBlock(ox + x, gy + y, oz + z, bt); } } } } for (var y = 2; y < h - 1; y += 2) { for (var x = 1; x < w - 1; x += 2) setBlock(ox + x, gy + y, oz + d - 1, PAL.GLASS); } setBlock(ox + Math.floor(w / 2), gy, oz + d - 1, PAL.AIR); setBlock(ox + Math.floor(w / 2), gy + 1, oz + d - 1, PAL.AIR); setBlock(ox + Math.floor(w / 2) - 1, gy, oz + d, PAL.STONE); setBlock(ox + Math.floor(w / 2), gy, oz + d, PAL.STONE); setBlock(ox + Math.floor(w / 2) + 1, gy, oz + d, PAL.STONE); }
  ...
  CITIES.hostomel = [
    ...
    { type: 'sovietApartment', params: [16, 8, 5, 0.3, 9], x: 65, z: 15, note: 'Soviet apartment block' },
    { type: 'sovietApartment', params: [14, 7, 4, 0.5, 9], x: 55, z: 40, note: 'Residential block (heavily damaged — 40% of Hostomel destroyed)' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 70, z: 30, note: 'Soviet apartment block' },
    ...
    { type: 'kyivBaroqueChurch', params: [10, 12, 6, 5], x: 45, z: -35, note: 'St. George Church (Kyiv baroque: green roof, golden domes, blue/white bell tower)' },
  ...
  CITIES.kyiv = [
    ...
    { type: 'parliamentBuilding', params: [16, 12, 6], x: 18, z: -10, note: 'Verkhovna Rada (Parliament) — Hrushevsky St, government quarter' },
    { type: 'officeBuilding', params: [12, 10, 5], x: 15, z: -8, note: 'Cabinet of Ministers — near Parliament' },
    { type: 'kyivBaroqueChurch', params: [14, 16, 10, 5], x: -20, z: -18, note: 'St. Sophia Cathedral — Upper Town, NW of Maidan (UNESCO, green roof, golden domes, 76m blue bell tower)' },
    { type: 'kyivBaroqueChurch', params: [12, 14, 8, 5], x: -12, z: -15, note: 'St. Michael’s Golden-Domed Monastery — near St. Sophia, golden domes, blue walls' },
    ...
    { type: 'kyivBaroqueChurch', params: [16, 18, 12, 7], x: 22, z: 20, note: 'Kyiv Pechersk Lavra — SE of center, on Dnipro uplands (UNESCO, 96m Great Lavra Bell Tower, golden domes, Dormition Cathedral)' },
    ...
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: -20, z: 30, note: 'Khreshchatyk apartment' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 0, z: 30, note: 'Khreshchatyk apartment' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 20, z: 30, note: 'Khreshchatyk apartment' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 40, z: 30, note: 'Khreshchatyk apartment' },
    { type: 'sovietApartment', params: [16, 8, 6, 0.2, 9], x: -40, z: 45, note: 'Pechersk apartment — near Dnipro' },
    { type: 'sovietApartment', params: [16, 8, 6, 0.2, 9], x: -20, z: 45, note: 'Pechersk apartment' },
    { type: 'sovietApartment', params: [16, 8, 6, 0.2, 9], x: 0, z: 45, note: 'Pechersk apartment' },
    { type: 'sovietApartment', params: [16, 8, 6, 0.2, 9], x: 20, z: 45, note: 'Pechersk apartment' },
    { type: 'sovietApartment', params: [16, 8, 6, 0.2, 9], x: 40, z: 45, note: 'Pechersk apartment' },
  ...
  // ═══════════════════════════════════════════════════════════
  CITIES.moscow = [
    { type: 'kremlinWall', params: [80, 60, 8], x: 0, z: 0, note: 'Kremlin walls — triangular fortification, red brick, towers with green roofs and ruby stars, Spasskaya Tower with clock' },
    ...
    { type: 'stateHistoricalMuseum', params: [12, 8, 4], x: -30, z: 30, note: 'State Historical Museum — north of Red Square (red brick, white trim, pointed towers)' },
    { type: 'gumDepartmentStore', params: [12, 8, 4], x: 30, z: 30, note: 'GUM Department Store — east side of Red Square (glass roof arcade)' },
    ...
    { type: 'lubyankaBuilding', params: [12, 10, 6], x: -40, z: -20, note: 'Lubyanka FSB HQ — northeast of Kremlin, former KGB (yellow neo-baroque)' },
    { type: 'officeBuilding', params: [12, 10, 6], x: 40, z: -20, note: 'MVD headquarters — east of Kremlin' },
    { type: 'bolshoiTheatre', params: [12, 10, 6], x: -35, z: -40, note: 'Bolshoi Theatre — north of Kremlin, Theater Square (white columns, pediment, Apollo chariot)' },
    ...
    { type: 'sovietApartment', params: [18, 10, 9, 0.1, 9], x: -20, z: -30, note: '9-story apartment' },
    { type: 'sovietApartment', params: [18, 10, 9, 0.1, 9], x: 0, z: -30, note: '9-story apartment' },
    { type: 'sovietApartment', params: [18, 10, 9, 0.1, 9], x: 20, z: -30, note: '9-story apartment' },
    { type: 'sovietApartment', params: [18, 10, 9, 0.1, 9], x: 40, z: -30, note: '9-story apartment' },
    { type: 'sovietApartment', params: [16, 8, 12, 0.1, 9], x: -50, z: -10, note: '12-story tower — inner ring' },
    { type: 'sovietApartment', params: [16, 8, 12, 0.1, 9], x: -25, z: -10, note: '12-story tower' },
    { type: 'sovietApartment', params: [16, 8, 12, 0.1, 9], x: 0, z: -10, note: '12-story tower' },
    { type: 'sovietApartment', params: [16, 8, 12, 0.1, 9], x: 25, z: -10, note: '12-story tower' },
    { type: 'sovietApartment', params: [16, 8, 12, 0.1, 9], x: 50, z: -10, note: '12-story tower' },
  ...
  // ═══════════════════════════════════════════════════════════
  CITIES.mariupol = [
    { type: 'azovstalComplex', params: [50, 30, 10], x: 0, z: -20, note: 'Azovstal Blast Furnace Hall — north of center, industrial heart (blast furnaces, cooling towers, smokestacks)' },
    { type: 'azovstalComplex', params: [40, 20, 8], x: -45, z: -25, note: 'Azovstal Rolling Mill 1 — northwest industrial zone' },
    { type: 'azovstalComplex', params: [35, 18, 7], x: 45, z: -25, note: 'Azovstal Rolling Mill 2 — northeast industrial zone' },
    ...
    { type: 'sovietApartment', params: [16, 8, 5, 0.6, 9], x: -60, z: 35, note: 'Heavily damaged apartment — east residential' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.7, 9], x: -60, z: 55, note: 'Ruined apartment — east residential' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.5, 9], x: 60, z: 15, note: 'Damaged apartment (west) — residential near coast' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.6, 9], x: 60, z: 35, note: 'Heavily damaged apartment — west residential' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.7, 9], x: 60, z: 55, note: 'Ruined apartment — west residential' },
    { type: 'dramaTheater', params: [14, 10, 5], x: -20, z: 25, note: 'Ruined Drama Theater — city center, Freedom Square area (modernist, bombed with CHILDREN sign)' },
    { type: 'ruinedBuilding', params: [12, 8, 4, 2.0], x: -5, z: 25, note: 'Ruined Kuindzhi Art Center — city center (white building)' },
  ...
  CITIES.avdiivka = [
    ...
    { type: 'sovietApartment', params: [18, 9, 6, 0.6, 9], x: 30, z: -25, note: 'Apartment block (heavily damaged) — southeast' },
    { type: 'sovietApartment', params: [18, 9, 5, 0.4, 9], x: 50, z: -30, note: 'Apartment block (ruined) — southeast' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.3, 9], x: 15, z: -40, note: 'Apartment block — south' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.5, 9], x: 35, z: -35, note: 'Apartment block (damaged) — south' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 55, z: -25, note: 'Apartment block — far southeast' },
    { type: 'sovietApartment', params: [14, 7, 4, 0.3, 9], x: -65, z: -10, note: 'Small apartment — west of plant' },
    { type: 'sovietApartment', params: [14, 7, 4, 0.4, 9], x: 65, z: -10, note: 'Small apartment (damaged) — far east' },
    ...
    { type: 'sovietApartment', params: [12, 6, 3, 0.2, 9], x: -70, z: 0, note: 'Workers housing — far west' },
  ...
  // ═══════════════════════════════════════════════════════════
  CITIES.bakhmut = [
    { type: 'ruinedBuilding', params: [18, 10, 6, 3.0], x: 0, z: 0, note: 'Bakhmut Fortress ruins — central market and embankment area (18th century)' },
    ...
    { type: 'school', params: [10, 8, 3], x: -10, z: -20, note: 'Museum of Local Lore (destroyed)' },
    { type: 'ruinedBuilding', params: [8, 6, 3, 2.0], x: 15, z: -20, note: 'Destroyed apartment (post-2022)' },
  ];
  ...
  // ═══════════════════════════════════════════════════════════
  CITIES.kherson = [
    { type: 'antonovskyBridge', params: [50, 6, 4], x: 0, z: 40, note: 'Antonivsky Bridge — crosses Dnipro south of city (cable-stayed, bombed)' },
    ...
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: -20, z: -10, note: 'Apartment block — west bank' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 0, z: -10, note: 'Apartment block — city center' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 20, z: -10, note: 'Apartment block — city center' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 40, z: -10, note: 'Apartment block — east approach' },
    { type: 'officeBuilding', params: [10, 8, 4], x: -45, z: 10, note: 'City hall — central Kherson' },
    { type: 'orthodoxChurch', params: [8, 10, 5], x: -25, z: 10, note: 'St. Catherine Church — central Kherson (baroque)' },
    ...
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: -40, z: 30, note: 'Residential block — south of center' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: -20, z: 30, note: 'Residential block — south of center' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 0, z: 30, note: 'Residential block — south of center' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 20, z: 30, note: 'Residential block — south of center' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 40, z: 30, note: 'Residential block — south of center' },
  ...
  // ═══════════════════════════════════════════════════════════
  CITIES.crimea = [
    { type: 'crimeaBridge', params: [60, 6, 3], x: -30, z: 0, note: 'Crimea Bridge (road) — Kerch Strait, 19km, road + rail' },
    { type: 'crimeaBridge', params: [60, 4, 2], x: -30, z: 8, note: 'Crimea Bridge (rail) — Kerch Strait' },
  ...
  CITIES.chornobyl = [
    ...
    { type: 'coolingTower', params: [18], x: 0, z: -70, note: 'Cooling Tower 1' },
    { type: 'coolingTower', params: [18], x: 25, z: -70, note: 'Cooling Tower 2' },
    { type: 'sovietApartment', params: [18, 10, 8, 0.1, 9], x: -40, z: 10, note: 'Pripyat 16-story block' },
    { type: 'sovietApartment', params: [18, 10, 8, 0.1, 9], x: -20, z: 10, note: 'Pripyat 16-story block' },
    { type: 'sovietApartment', params: [18, 10, 8, 0.1, 9], x: 0, z: 10, note: 'Pripyat 16-story block' },
    { type: 'sovietApartment', params: [18, 10, 8, 0.1, 9], x: 20, z: 10, note: 'Pripyat 16-story block' },
    { type: 'sovietApartment', params: [18, 10, 8, 0.1, 9], x: 40, z: 10, note: 'Pripyat 16-story block' },
    { type: 'sovietApartment', params: [16, 8, 6, 0.1, 9], x: -40, z: 30, note: 'Pripyat 9-story block' },
    { type: 'sovietApartment', params: [16, 8, 6, 0.1, 9], x: -20, z: 30, note: 'Pripyat 9-story block' },
    { type: 'sovietApartment', params: [16, 8, 6, 0.1, 9], x: 0, z: 30, note: 'Pripyat 9-story block' },
    { type: 'sovietApartment', params: [16, 8, 6, 0.1, 9], x: 20, z: 30, note: 'Pripyat 9-story block' },
    { type: 'sovietApartment', params: [16, 8, 6, 0.1, 9], x: 40, z: 30, note: 'Pripyat 9-story block' },
  ...
  CITIES.sevastopol = [
    ...
    { type: 'officeBuilding', params: [12, 10, 5], x: -30, z: 5, note: 'Black Sea Fleet HQ — north shore, west (grandiose naval building)' },
    ...
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: -20, z: 40, note: 'Naval housing — north' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 0, z: 40, note: 'Naval housing — north' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 20, z: 40, note: 'Naval housing — north' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 40, z: 40, note: 'Naval housing — north' },
  ...
  CITIES.donbas = [
    ...
    { type: 'sovietApartment', params: [16, 8, 5, 0.3, 9], x: -20, z: -30, note: 'Miners housing' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.3, 9], x: 0, z: -30, note: 'Miners housing' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.3, 9], x: 20, z: -30, note: 'Miners housing' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.3, 9], x: 40, z: -30, note: 'Miners housing' },
  ...
  CITIES.belgorod = [
    ...
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: -20, z: -20, note: 'Apartment block — city center north' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 0, z: -20, note: 'Apartment block — city center north' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 20, z: -20, note: 'Apartment block — city center north' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 40, z: -20, note: 'Apartment block — city center north' },
    ...
    { type: 'orthodoxChurch', params: [8, 10, 5], x: -30, z: 20, note: 'Trinity Cathedral — city center south' },
    ...
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: -40, z: 40, note: 'Residential block — south' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: -20, z: 40, note: 'Residential block — south' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 0, z: 40, note: 'Residential block — south' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 20, z: 40, note: 'Residential block — south' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.2, 9], x: 40, z: 40, note: 'Residential block — south' },
  ...
  // ═══════════════════════════════════════════════════════════
  CITIES.kremlin = [
    { type: 'kremlinWall', params: [80, 60, 8], x: 0, z: 0, note: 'Kremlin walls — triangular fortification, red brick, towers with green roofs and ruby stars' },
    ...
    { type: 'stateHistoricalMuseum', params: [12, 8, 4], x: -30, z: 35, note: 'State Historical Museum — north of Red Square' },
    ...
    { type: 'lubyankaBuilding', params: [12, 10, 6], x: -50, z: 0, note: 'Lubyanka FSB HQ — northeast of Kremlin' },
    ...
    { type: 'sovietApartment', params: [16, 8, 6, 0.1, 9], x: 50, z: -30, note: 'Rossiya Hotel — northeast' },
    { type: 'bolshoiTheatre', params: [10, 8, 5], x: -50, z: 30, note: 'Moscow State University — northwest, near Sparrow Hills' },
    { type: 'bolshoiTheatre', params: [10, 8, 5], x: 50, z: 30, note: 'Bolshoi Theatre — northeast, Theater Square' },
  ...
  CITIES.vuhledar = [
    ...
    { type: 'sovietApartment', params: [16, 8, 5, 0.6, 9], x: -10, z: -20, note: 'Heavily damaged apartment' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.7, 9], x: 10, z: -20, note: 'Ruined apartment' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.5, 9], x: 30, z: -20, note: 'Damaged apartment' },
  ...
  // ═══════════════════════════════════════════════════════════
  CITIES.antonov = [
    { type: 'antonovskyBridge', params: [50, 6, 4], x: -25, z: 0, note: 'Antonovsky Bridge (damaged) — cable-stayed, bombed sections' },
    ...
    { type: 'sovietApartment', params: [16, 8, 5, 0.3, 9], x: -20, z: -30, note: 'Apartment block' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.3, 9], x: 0, z: -30, note: 'Apartment block' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.3, 9], x: 20, z: -30, note: 'Apartment block' },
    { type: 'sovietApartment', params: [16, 8, 5, 0.3, 9], x: 40, z: -30, note: 'Apartment block' },
    ...
    { type: 'ruinedBuilding', params: [10, 8, 3, 1.5], x: 30, z: 40, note: 'Damaged house' },
    { type: 'sovietApartment', params: [12, 6, 3, 0.2, 9], x: -50, z: 30, note: 'Small apartment' },
    { type: 'sovietApartment', params: [12, 6, 3, 0.2, 9], x: 50, z: 30, note: 'Small apartment' },
  ];
  ...
  // ═══════════════════════════════════════════════════════════
  CITIES.refinery = [
    { type: 'distillationTower', params: [20], x: 0, z: 0, note: 'Main distillation tower' },
    { type: 'distillationTower', params: [16], x: -25, z: -10, note: 'Cracking unit' },
    { type: 'distillationTower', params: [16], x: 25, z: -10, note: 'Reforming unit' },
    ...
    { type: 'storageTank', params: [6, 8], x: -40, z: 15, note: 'Crude oil storage tank' },
    { type: 'storageTank', params: [6, 8], x: -28, z: 15, note: 'Crude oil storage tank' },
    { type: 'storageTank', params: [5, 6], x: 40, z: 15, note: 'Product storage tank' },
    { type: 'storageTank', params: [5, 6], x: 28, z: 15, note: 'Product storage tank' },
    { type: 'industrialFactory', params: [20, 12, 5], x: 0, z: -30, note: 'Sulfur recovery' },
    { type: 'storageTank', params: [5, 6], x: -25, z: 25, note: 'Tank farm' },
    { type: 'storageTank', params: [5, 6], x: 25, z: 25, note: 'Tank farm' },
  ...
  // ═══════════════════════════════════════════════════════════
  CITIES.treeline = [
    { type: 'trenches', params: [20], x: -20, z: -15, note: 'Forward trench bunker' },
    { type: 'trenches', params: [20], x: -10, z: -15, note: 'Trench bunker' },
    { type: 'trenches', params: [20], x: 0, z: -15, note: 'Trench bunker' },
    { type: 'trenches', params: [20], x: 10, z: -15, note: 'Trench bunker' },
    { type: 'trenches', params: [20], x: 20, z: -15, note: 'Trench bunker' },
    ...
    { type: 'dragonTeeth', params: [10], x: -40, z: -5, note: 'Anti-tank obstacles' },
    { type: 'dragonTeeth', params: [10], x: 40, z: -5, note: 'Anti-tank obstacles' },
    { type: 'dragonTeeth', params: [10], x: -40, z: 10, note: 'Anti-tank obstacles' },
    { type: 'dragonTeeth', params: [10], x: 40, z: 10, note: 'Anti-tank obstacles' },
