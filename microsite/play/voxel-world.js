...
window.VoxelWorld = (function () {
  ...
  const BLOCK_COLORS = {
    ...
    [BLOCK.UKR_BLUE]:    0x0057B7,
    [BLOCK.UKR_YELLOW]:  0xFFD700,
    [BLOCK.UKR_FLAG]:    0x0057B7,
    [BLOCK.UKR_BANNER]:  0xFFD700,
    [BLOCK.TRYZUB]:      0xFFD700,
    [BLOCK.UKR_VEHICLE]: 0x4B5320,
    [BLOCK.BRICK_DARK_RED]:   0x8B2500,
    [BLOCK.BRICK_RED]:        0xA52A2A,
    [BLOCK.BRICK_BROWN]:      0x8B4513,
    [BLOCK.BRICK_YELLOW]:     0xDAA520,
    [BLOCK.BRICK_ORANGE]:     0xFF8C00,
    [BLOCK.BRICK_PINK]:       0xE6A8B3,
    [BLOCK.BRICK_GREY]:       0x808080,
    [BLOCK.BRICK_WHITE]:      0xF5F5F5,
    [BLOCK.CONCRETE_LIGHT]:   0xC0C0C0,
    [BLOCK.CONCRETE_DARK]:    0x505050,
    [BLOCK.CONCRETE_BEIGE]:   0xD2B48C,
    [BLOCK.CONCRETE_WARM]:    0xB8A88A,
    [BLOCK.PLASTER_WHITE]:    0xFFFFFF,
    [BLOCK.PLASTER_CREAM]:    0xFFFDD0,
    [BLOCK.PLASTER_YELLOW]:   0xFFF8DC,
    [BLOCK.PLASTER_PEACH]:    0xFFDAB9,
    [BLOCK.PLASTER_SALMON]:   0xFA8072,
    [BLOCK.PLASTER_BLUE]:     0xADD8E6,
    [BLOCK.PLASTER_GREEN]:    0x90EE90,
    [BLOCK.PLASTER_LAVENDER]: 0xE6E6FA,
    [BLOCK.METAL_SILVER]:     0xC0C0C0,
    [BLOCK.METAL_DARK]:       0x2F4F4F,
    [BLOCK.METAL_RUST]:       0xB7410E,
    [BLOCK.METAL_COPPER]:     0xB87333,
    [BLOCK.METAL_BRONZE]:     0xCD7F32,
    [BLOCK.ROOF_TERRACOTTA]:  0xE2725B,
    [BLOCK.ROOF_DARK_BROWN]:  0x3B2F2F,
    [BLOCK.ROOF_GREEN]:       0x2E8B57,
    [BLOCK.ROOF_BLUE]:        0x4682B4,
    [BLOCK.ROOF_BLACK]:       0x1C1C1C,
    [BLOCK.GLASS_BLUE]:       0x5B9BD5,
    [BLOCK.GLASS_GREEN]:      0x6B8E6F,
    [BLOCK.GLASS_DARK]:       0x191970,
    [BLOCK.STONE_LIMESTONE]:  0xF5F5DC,
    [BLOCK.STONE_SANDSTONE]:  0xC2B280,
    [BLOCK.STONE_GRANITE]:    0x837E7C,
    [BLOCK.STONE_MARBLE]:     0xF0F0F0,
    [BLOCK.WOOD_DARK]:        0x3E2723,
    [BLOCK.WOOD_LIGHT]:       0xDEB887,
    [BLOCK.WOOD_RED]:         0x800000,
    [BLOCK.FACADE_BEIGE]:     0xD2B48C,
    [BLOCK.FACADE_GREY]:      0xA9A9A9,
    [BLOCK.FACADE_GREEN]:     0x8FBC8F,
    [BLOCK.FACADE_BLUE]:      0x6495ED,
    [BLOCK.FACADE_PINK]:      0xFFB6C1,
    [BLOCK.FACADE_OCHRE]:     0xCC7722,
    [BLOCK.FACADE_TERRA]:     0xE2725B,
    [BLOCK.FACADE_SAND]:      0xC2B280,
    [BLOCK.FACADE_MINT]:      0x98FF98,
    [BLOCK.FACADE_LAVENDER]:  0xE6E6FA,
    [BLOCK.FACADE_CORAL]:     0xFF7F50,
    [BLOCK.FACADE_OLIVE]:     0x808000,
    [BLOCK.FACADE_TEAL]:      0x008080,
  ...
  /* ── Level Definitions ────────────────────────────────────────────── */
  const LEVELS = [
    { id: 'HOSTOMEL',  name: 'Hostomel Airport',    desc: 'Stop the airborne assault',  theme: 'grassland', wavesPerLevel: 7, difficulty: 1.0, fogColor: 0xD4A017, spawnCandidates: [{ x: 0, z: -34 }, { x: -10, z: -34 }, { x: 10, z: -34 }, { x: -6, z: -30 }, { x: 6, z: -30 }], spawnLookTarget: { x: 0, z: 0 } },
    { id: 'AVDIIVKA',  name: 'Avdiivka Industrial Zone', desc: 'Hold the coking plant',  theme: 'urban',     wavesPerLevel: 7, difficulty: 1.3, fogColor: 0x3a3028, spawnCandidates: [{ x: 30, z: 20 }, { x: 20, z: 30 }, { x: 40, z: 20 }, { x: 30, z: 30 }, { x: 25, z: 25 }], spawnLookTarget: { x: -20, z: -20 } },
    { id: 'BAKHMUT',   name: 'Bakhmut Ruins',        desc: 'Defend the city',             theme: 'urban',     wavesPerLevel: 7, difficulty: 1.6, fogColor: 0x2a2a2a, spawnCandidates: [{ x: 0, z: -30 }, { x: -10, z: -30 }, { x: 10, z: -30 }, { x: -6, z: -34 }, { x: 6, z: -34 }], spawnLookTarget: { x: 0, z: 0 } },
    { id: 'KHERSON',   name: 'Kherson Bridgehead',   desc: 'Cross the Dnipro',            theme: 'grassland', wavesPerLevel: 7, difficulty: 1.9, fogColor: 0xD4A017, spawnCandidates: [{ x: 0, z: -30 }, { x: -10, z: -30 }, { x: 10, z: -30 }, { x: -6, z: -34 }, { x: 6, z: -34 }], spawnLookTarget: { x: 0, z: 0 } },
    { id: 'MARIUPOL',  name: 'Mariupol Steelworks',  desc: 'Fight through Azovstal',      theme: 'industrial', wavesPerLevel: 7, difficulty: 2.2, fogColor: 0x1a1a20, spawnCandidates: [{ x: 0, z: -30 }, { x: -20, z: -30 }, { x: 20, z: -30 }, { x: 30, z: -26 }, { x: -30, z: 20 }], spawnLookTarget: { x: -20, z: 25 } },
    { id: 'CRIMEA',    name: 'Crimea Bridge',        desc: 'Cut the supply line',         theme: 'coastal',   wavesPerLevel: 7, difficulty: 2.5, fogColor: 0x5577aa, spawnCandidates: [{ x: 0, z: 30 }, { x: -30, z: 0 }, { x: 30, z: 0 }, { x: 0, z: -30 }, { x: -20, z: -20 }], spawnLookTarget: { x: 0, z: 0 } },
    { id: 'CHORNOBYL', name: 'Chornobyl Zone',       desc: 'Irradiated exclusion zone',   theme: 'wasteland', wavesPerLevel: 7, difficulty: 2.8, fogColor: 0x3a3520, spawnCandidates: [{ x: 0, z: 50 }, { x: -20, z: 50 }, { x: 20, z: 50 }, { x: -10, z: 55 }, { x: 10, z: 55 }], spawnLookTarget: { x: 0, z: -40 } },
    { id: 'MOSCOW',    name: 'Moscow Finale',        desc: 'End it at the Kremlin',       theme: 'cityscape', wavesPerLevel: 9, difficulty: 3.5, fogColor: 0x222228, spawnCandidates: [{ x: 0, z: -34 }, { x: -4, z: -34 }, { x: 4, z: -34 }, { x: -2, z: -38 }, { x: 2, z: -38 }], spawnLookTarget: { x: 0, z: 30 } },
    { id: 'SEVASTOPOL', name: 'Sevastopol Naval Base', desc: 'Destroy the Black Sea Fleet', theme: 'coastal',  wavesPerLevel: 7, difficulty: 3.8, fogColor: 0x3355aa, spawnCandidates: [{ x: 0, z: -30 }, { x: -10, z: -30 }, { x: 10, z: -30 }, { x: -6, z: -34 }, { x: 6, z: -34 }], spawnLookTarget: { x: 0, z: 25 } },
    { id: 'DONBAS',    name: 'Donbas Final Push',     desc: 'Liberate the last stronghold', theme: 'urban',   wavesPerLevel: 8, difficulty: 4.2, fogColor: 0x2a2020, spawnCandidates: [{ x: 0, z: 30 }, { x: -20, z: 30 }, { x: 20, z: 30 }, { x: 30, z: 0 }, { x: -30, z: 0 }], spawnLookTarget: { x: 0, z: 0 } },
    { id: 'BELGOROD',  name: 'Belgorod Offensive',    desc: 'Cross into enemy territory',   theme: 'grassland', wavesPerLevel: 8, difficulty: 4.6, fogColor: 0xD4A017, spawnCandidates: [{ x: 30, z: 0 }, { x: -30, z: 0 }, { x: 30, z: -20 }, { x: -30, z: -20 }, { x: 30, z: 20 }, { x: -30, z: 20 }], spawnLookTarget: { x: 0, z: 0 } },
    { id: 'KREMLIN',   name: 'Kremlin Showdown',      desc: 'The final battle for peace',   theme: 'cityscape', wavesPerLevel: 10, difficulty: 5.0, fogColor: 0x111118, spawnCandidates: [{ x: 0, z: -30 }, { x: -10, z: -30 }, { x: 10, z: -30 }, { x: -6, z: -34 }, { x: 6, z: -34 }], spawnLookTarget: { x: 0, z: 30 } },
    { id: 'KYIV',      name: 'Siege of Kyiv',         desc: 'Ambush the Russian armored convoy', theme: 'urban', wavesPerLevel: 8, difficulty: 1.5, fogColor: 0x6a7080, tankFocus: true, spawnCandidates: [{ x: 0, z: -30 }, { x: -10, z: -30 }, { x: 10, z: -30 }, { x: -6, z: -34 }, { x: 6, z: -34 }], spawnLookTarget: { x: 0, z: 0 } },
    { id: 'SNAKE',     name: 'Snake Island Defense',  desc: '"Russian warship, go fuck yourself."', theme: 'coastal', wavesPerLevel: 6, difficulty: 1.4, fogColor: 0x4a6680, spawnCandidates: [{ x: 20, z: 0 }, { x: -20, z: 0 }, { x: 0, z: 20 }, { x: 0, z: -20 }, { x: 15, z: 15 }, { x: -15, z: -15 }], spawnLookTarget: { x: 0, z: 0 } },
    { id: 'SAKY',      name: 'Saky Airbase Strike',   desc: 'Crimea airbase — ground every Su-24', theme: 'coastal', wavesPerLevel: 7, difficulty: 1.7, fogColor: 0x886644, spawnCandidates: [{ x: 0, z: 40 }, { x: -15, z: 40 }, { x: 15, z: 40 }, { x: -10, z: 45 }, { x: 10, z: 45 }], spawnLookTarget: { x: 0, z: 0 } },
    { id: 'VUHLEDAR',  name: 'Vuhledar Tank Graveyard', desc: 'Bury the 155th in the minefield', theme: 'wasteland', wavesPerLevel: 8, difficulty: 1.9, fogColor: 0x4a4030, tankFocus: true, spawnCandidates: [{ x: 0, z: -30 }, { x: -20, z: -30 }, { x: 20, z: -30 }, { x: 30, z: 0 }, { x: -30, z: 0 }], spawnLookTarget: { x: 0, z: 0 } },
    { id: 'ANTONOV',   name: 'Antonov Bridge Strike', desc: 'HIMARS the supply line into Kherson', theme: 'urban', wavesPerLevel: 7, difficulty: 2.0, fogColor: 0x556677, spawnCandidates: [{ x: 0, z: -30 }, { x: -20, z: -30 }, { x: 20, z: -30 }, { x: -10, z: -34 }, { x: 10, z: -34 }], spawnLookTarget: { x: 0, z: 0 } },
    { id: 'REFINERY',  name: 'Refinery Strike (FPV)', desc: 'Fly an FPV drone into the oil refinery', theme: 'industrial', wavesPerLevel: 1, difficulty: 1.6, fogColor: 0x2a2620, droneOnly: true, spawnCandidates: [{ x: 0, z: 50 }, { x: -10, z: 50 }, { x: 10, z: 50 }, { x: -6, z: 45 }, { x: 6, z: 45 }], spawnLookTarget: { x: 0, z: 0 } },
  ...
  // ── Moscow City Extension: the Kremlin, St Basil's, Red Square ───────
  // "Siege of Moscow" — Ukrainian fighters have reached the capital. Built
  // from the same proven voxel kit as the Kyiv extension. The Kremlin's
  // towers fly Ukrainian flags; the war ends here.
